      ...
      <div class="dropdown d-inline-block ms-2">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 border-0 fs-sm" aria-labelledby="page-header-notifications-dropdown">
          <div class="p-2 bg-body-light border-bottom text-center rounded-top">
            <h5 class="dropdown-header text-uppercase">作品信息</h5>
          </div>
          <ul class="nav-items mb-0">
            <li>
              <a class="text-dark d-flex py-2" href="javascript:void(0)">
                ...
                <div class="flex-grow-1 pe-2">
                  <div class="fw-semibold">作品类型：<?php if ($project['type'] == 'web') {echo "网页";}else{echo "程序";}?></div>
                </div>
              </a>
            </li>
            <li>
              <a class="text-dark d-flex py-2" href="javascript:void(0)">
                ...
                <div class="flex-grow-1 pe-2">
                  <div class="fw-semibold">项目名称：<?php echo $project['name'];?></div>
                </div>
              </a>
            </li>
            <li>
              <a class="text-dark d-flex py-2" href="javascript:void(0)">
                ...
                <div class="flex-grow-1 pe-2">
                  <div class="fw-semibold">作品价格：<?php echo $project['money'];?></div>
                </div>
              </a>
            </li>
            <li>
            ...
            <li>
              <a class="text-dark d-flex py-2" href="//<?php echo $project['url'];?>" target="_blank">
                ...
                <div class="flex-grow-1 pe-2">
                  <div class="fw-semibold">项目网址：<?php echo $project['url'];?></div>
                </div>
              </a>
            </li>
            <li>
              <a class="text-dark d-flex py-2" href="javascript:void(0)">
                ...
                <div class="flex-grow-1 pe-2">
                  <div class="fw-semibold">运营状态：<?php if ($project['status'] == 1) {  echo "<font color='green'>正常运营</font>";}else{  echo "<<font color='red'>暂停运营</font>";} ?></div>
                </div>
              </a>
            </li>
          </ul>
...
<div class="bg-body-extra-light">
  <div class="content content-boxed">
    ...
    <div class="row justify-content-center">
      <div class="col-sm-8">
        <article class="story">
          <h3 class="fw-normal mt-5 mb-3  text-center">作品介绍</h3>
